...
VENDOR_SKIP_FILES=(
    ...
    "bin/hw/android.hardware.dumpstate@1.1-service.bramble"
    ...
    "bin/hw/android.hardware.usb-service.bramble"
    "bin/hw/android.hardware.usb.gadget-service.bramble"
    "bin/hw/android.hardware.vibrator-service.bramble"
    ...
    "etc/bluetooth_power_limits_G6QU3.csv"
    "etc/bluetooth_power_limits_G6QU3_EU.csv"
    "etc/bluetooth_power_limits_G6QU3_JP.csv"
    "etc/bluetooth_power_limits_G6QU3_US.csv"
    ...
    "etc/init/android.hardware.dumpstate@1.1-service.bramble.rc"
    ...
    "etc/init/android.hardware.usb.gadget-service.bramble.rc"
    "etc/init/android.hardware.vibrator-service.bramble.rc"
    ...
    "etc/vintf/manifest/android.hardware.usb.gadget@1.1-service.bramble.xml"
    "etc/vintf/manifest/android.hardware.vibrator-service.bramble.xml"
    ...
    "firmware/R-cs35l41-mmW-dsp1-spk-cali.bin"
    "firmware/R-cs35l41-mmW-dsp1-spk-diag.bin"
    "firmware/R-cs35l41-mmW-dsp1-spk-prot.bin"
    ...
    "firmware/cs35l41-mmW-dsp1-spk-cali.bin"
    "firmware/cs35l41-mmW-dsp1-spk-cali.wmfw"
    "firmware/cs35l41-mmW-dsp1-spk-diag.bin"
    "firmware/cs35l41-mmW-dsp1-spk-diag.wmfw"
    "firmware/cs35l41-mmW-dsp1-spk-prot.bin"
    "firmware/cs35l41-mmW-dsp1-spk-prot.wmfw"
    ...
    # or manually added as build targets in device-custom.mk
